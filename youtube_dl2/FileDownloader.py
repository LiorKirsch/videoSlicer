...
class FileDownloader(object):
	...
	def __init__(self, params, videoFolder='.'):
...
#				output = output.encode(preferredencoding(), 'ignore')
	...
	def process_info(self, info_dict):
		...
		filename = os.path.join(self._videoFolder, filename)
			...
			for ie in self._ies:
				...
				for video in videos or []:
					try:
						...
						video['fileName'] = self._file_name
	...
	def _do_download(self, filename, info_dict):
		...
		if data_len/1024/1024 > 200:
			raise Exception("file larger then 200M")
